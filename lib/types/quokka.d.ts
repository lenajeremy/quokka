...
type HookSuffix<T, Tags> = T extends QuokkaApiQuery<any, any, Tags> ? "Query" : T extends QuokkaApiMutation<any, any, Tags> ? "Mutation" : never;
type HookFunction<T, Tags> = T extends QuokkaApiQuery<infer Takes, infer Returns, Tags> ? QueryHook<Takes, Returns, Error> : T extends QuokkaApiMutation<infer Takes, infer Returns, Tags> ? MutationHook<Takes, Returns, Error> : never;
