...
export type Color = "red" | "orange" | "yellow" | "green" | "turquoise" | "blue" | "violet" | "pink" | "brown" | "black" | "gray" | "white" | `#${string}`
...
const pexelsApi = createApi({
    ...
    prepareHeaders: (_, headers) => {
        const apikey = "uvZBWNPUBUF1mpb37KipAOCYuT8UOoVSR8aQmWq8pQAxIb04SfdxzfHD"
